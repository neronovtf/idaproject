<template>
    <div
        ...
        v-if="this.$store.state.popup.show"
    >
        <div
            class="popup"
            :style="styleObject"
        >
            ...
            <div class="buttons" v-if="getStatusServer != 'connect'">
                ...
                <div
                    class="confirm"
                    v-if="getStatusServer == 'allow'"
                    @click="goDelete()
                ">Confirm</div>
                <div
                    class="again"
                    v-else-if="getStatusServer == 'error'"
                    @click="goDelete()
                ">Again</div>
            </div>
        </div>
...
export default {
    ...
    computed:{
        ...
        getText: function(){
            ...
            switch (this.getStatusServer) { // 'connect', 'error', 'allow'
                case 'connect':
                ...
                case 'allow':
                    ...
                    break;
                case 'error':
                    text = '<b>Error</b>. Repeat again ('+this.$store.state.server.errorDel+')?'
                    break;
            }
